...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92WLOG';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92WLOG';
...
INSERT INTO PS.PSDBOWNER  VALUES ('HC92WLOG','SYSADM');
commit;
