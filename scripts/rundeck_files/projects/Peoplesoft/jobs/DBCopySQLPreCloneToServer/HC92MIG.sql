...
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, CREATE ANY TABLE, UPDATE ANY TABLE TO DTI1145159;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92MIG';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92MIG';
...
INSERT INTO PS.PSDBOWNER  VALUES ('HC92MIG','SYSADM');
commit;
