...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/FS91MIG';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/FS91MIG';
CREATE DIRECTORY INTEGRACAO_CR AS '/orabackup/intergracao_CR';
...
INSERT INTO PS.PSDBOWNER  VALUES ('FS91MIG','SYSADM');
commit;
