...
CREATE USER HQSAJULIO IDENTIFIED BY HQSAJULIO;
CREATE USER DTI1904944 IDENTIFIED BY DTI1904944;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO HQSAJULIO,DTI1904944;
...
-- DIRECTORIES
--**********************************
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92MHM2';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92MHM2';
...
INSERT INTO PS.PSDBOWNER  VALUES ('HC92MHM2','SYSADM');
