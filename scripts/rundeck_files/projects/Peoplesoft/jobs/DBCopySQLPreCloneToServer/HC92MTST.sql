...
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, CREATE ANY TABLE, UPDATE ANY TABLE TO DTI1903748,DTI1074573,DTI1905982,DTI1904944,DTI1073229,DTI1145159,DTI1148583,DTI1146678,DTI1906600,DTI1149227, DTI1160406,DTI4500087,DTI4500061;
...
CREATE TABLESPACE PTTLRG DATAFILE SIZE 512M AUTOEXTEND ON NEXT 128M MAXSIZE 32767M;
CREATE TABLESPACE HRAPP7 DATAFILE SIZE 1024M AUTOEXTEND ON NEXT 128 MAXSIZE 32767M;
CREATE TABLESPACE USERS DATAFILE SIZE 1024M AUTOEXTEND ON NEXT 128 MAXSIZE 32767M;
CREATE TABLESPACE HRAPP7 DATAFILE SIZE 1024M AUTOEXTEND ON NEXT 128 MAXSIZE 32767M;
CREATE TABLESPACE USERS DATAFILE SIZE 1024M AUTOEXTEND ON NEXT 128 MAXSIZE 32767M;
CREATE TABLESPACE TLAPP DATAFILE SIZE 4096M AUTOEXTEND ON NEXT 1024M MAXSIZE 32767M;
CREATE TABLESPACE TLLARGE DATAFILE SIZE 4096M AUTOEXTEND ON NEXT 1024M MAXSIZE 32767M;
CREATE TABLESPACE PSDEFAULT DATAFILE SIZE 4096M AUTOEXTEND ON NEXT 1024M MAXSIZE 32767M;
CREATE TABLESPACE HRAPP DATAFILE SIZE 4096M AUTOEXTEND ON NEXT 1024M MAXSIZE 32767M;
CREATE TABLESPACE TLWORK DATAFILE SIZE 4096M AUTOEXTEND ON NEXT 1024M MAXSIZE 32767M;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92MTST';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92MTST';
...
INSERT INTO PS.PSDBOWNER  VALUES ('HC92MTST','SYSADM');
...
ALTER USER DTI1074573 ACCOUNT UNLOCK;
ALTER USER DTI1140366 ACCOUNT UNLOCK;
...
ALTER USER DTI1906600 ACCOUNT UNLOCK;
ALTER USER DTI4500008 ACCOUNT UNLOCK;
ALTER USER DTI4500013 ACCOUNT UNLOCK;
ALTER USER DTI4500064 ACCOUNT UNLOCK;
