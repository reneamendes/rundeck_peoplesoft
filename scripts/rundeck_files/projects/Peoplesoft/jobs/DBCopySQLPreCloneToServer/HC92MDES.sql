...
CREATE USER DTI4500013 IDENTIFIED BY DTI4500013;
CREATE USER DTI4500061 IDENTIFIED BY DTI4500061;
CREATE USER DTI4500087 IDENTIFIED BY DTI4500087;
CREATE USER DTI4500210 IDENTIFIED BY DTI4500210;
CREATE USER DTI4500211 IDENTIFIED BY DTI4500211;

GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1073229;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1074573;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1137370;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1145159;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1146678;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1148583;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1149227;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1160406;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1903748;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1904944;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1905982;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1906600;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI4500013;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI4500061;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI4500087;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI4500210;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI4500211;
...
CREATE TABLESPACE PTAMSG DATAFILE SIZE 128M AUTOEXTEND ON NEXT 128M MAXSIZE 32767M;
...
--ALTER TABLESPACE PSINDEX ADD DATAFILE SIZE 24G AUTOEXTEND ON NEXT 8192M MAXSIZE UNLIMITED;
--ALTER TABLESPACE GPAPP ADD DATAFILE SIZE 24G AUTOEXTEND ON NEXT 8192M MAXSIZE UNLIMITED;
--ALTER TABLESPACE GPAPP ADD DATAFILE SIZE 8G AUTOEXTEND ON NEXT 8192M MAXSIZE UNLIMITED;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92MDES';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92MDES';
...
INSERT INTO PS.PSDBOWNER  VALUES ('HC92MDES','SYSADM');
