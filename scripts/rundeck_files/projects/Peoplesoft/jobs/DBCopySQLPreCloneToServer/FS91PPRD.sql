...
GRANT DBA, DROP ANY TABLE, CREATE ANY TABLE, DATAPUMP_IMP_FULL_DATABASE, insert any table TO DTI1145159;
...
CREATE USER DTI4500041 IDENTIFIED BY DTI4500041;
CREATE USER DTI1141992 IDENTIFIED BY DTI1141992;
CREATE USER DTI1169647 IDENTIFIED BY DTI1169647;

GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1073229;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1141992;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1145159;
...
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1707131;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI4500041;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1141992;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1169647;

CREATE DIRECTORY INTEGRACAO_CR AS '/orabackup/intergracao_CR';
GRANT READ,WRITE ON DIRECTORY INTEGRACAO_CR TO PUBLIC;
...
CREATE TABLESPACE MGLARGE DATAFILE SIZE 8M AUTOEXTEND ON NEXT 8M MAXSIZE 32767M;
...
CREATE TABLESPACE EXLARGE DATAFILE SIZE 32M AUTOEXTEND ON NEXT 32M MAXSIZE 32767M;
...
CREATE TABLESPACE INWORK DATAFILE SIZE 128M AUTOEXTEND ON NEXT 128M MAXSIZE 32767M;
...
CREATE TABLESPACE ARLARGE DATAFILE SIZE 1024M AUTOEXTEND ON NEXT 512M MAXSIZE 32767M;
...
CREATE TABLESPACE POAPP DATAFILE SIZE 2048M AUTOEXTEND ON NEXT 512M MAXSIZE 32767M;
...
CREATE TABLESPACE UNDOTBS DATAFILE SIZE 4096M AUTOEXTEND ON NEXT 2048M MAXSIZE 32767M;
...
-- ALTER TABLESPACE PSINDEX ADD DATAFILE SIZE 8192M AUTOEXTEND ON NEXT 8192M MAXSIZE UNLIMITED;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/FS91PPRD';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/FS91PPRD';
CREATE DIRECTORY INTEGRACAO_CR AS '/orabackup/intergracao_CR';
...
INSERT INTO PS.PSDBOWNER  VALUES ('FS91PPRD','SYSADM');
commit;
...
ALTER USER DTI1073229 ACCOUNT UNLOCK;
ALTER USER DTI1145159 ACCOUNT UNLOCK;
ALTER USER DTI1147858 ACCOUNT UNLOCK;
ALTER USER DTI1149524 ACCOUNT UNLOCK;
ALTER USER DTI1707131 ACCOUNT UNLOCK;
ALTER USER DTI4500041 ACCOUNT UNLOCK;
...
alter user sysadm identified by V7TQP8TQ;
ALTER USER DTI1145159 IDENTIFIED BY oracle123;
