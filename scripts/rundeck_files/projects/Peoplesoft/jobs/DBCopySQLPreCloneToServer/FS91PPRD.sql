...
GRANT DBA, DROP ANY TABLE, CREATE ANY TABLE, DATAPUMP_IMP_FULL_DATABASE, insert any table TO [DBIMPUSER];
...
CREATE DIRECTORY ORABACKUP AS '/FS91PPRD';
CREATE DIRECTORY EXPDP_DIR AS '/FS91PPRD';
