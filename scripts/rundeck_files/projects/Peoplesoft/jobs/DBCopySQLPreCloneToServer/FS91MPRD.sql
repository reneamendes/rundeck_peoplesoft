...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/FS91MPRD';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/FS91MPRD';
CREATE DIRECTORY INTEGRACAO_CR AS '/orabackup/intergracao_CR';
...
INSERT INTO PS.PSDBOWNER  VALUES ('FS91MPRD','SYSADM');
commit;
