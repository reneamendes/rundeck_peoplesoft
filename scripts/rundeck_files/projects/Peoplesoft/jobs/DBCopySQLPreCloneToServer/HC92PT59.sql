...
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, INSERT ANY TABLE, UPDATE ANY TABLE, DBA, DROP ANY TABLE, CREATE ANY TABLE, DATAPUMP_IMP_FULL_DATABASE TO DTI1145159;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92PT59';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92PT59';
...
INSERT INTO PS.PSDBOWNER  VALUES ('HC92PT59','SYSADM');
commit;
