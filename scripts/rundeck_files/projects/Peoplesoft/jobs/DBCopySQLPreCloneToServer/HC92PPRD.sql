...
CREATE USER DTI4500430 IDENTIFIED BY DTI4500430;
CREATE USER DTI1162873 IDENTIFIED BY DTI1162873;
...
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI4500430;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1162873;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92PPRD';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92PPRD';
