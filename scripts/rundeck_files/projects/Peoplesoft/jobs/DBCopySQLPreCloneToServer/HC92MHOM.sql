...
CREATE USER DTI1141942 IDENTIFIED BY DTI1141942;
CREATE USER DTI1141992 IDENTIFIED BY DTI1141992;
CREATE USER DTI1145159 IDENTIFIED BY DTI1145159;
CREATE USER DTI1147163 IDENTIFIED BY DTI1147163;
...
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1140366;
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1141942;
...
GRANT CREATE SESSION, SELECT ANY TABLE, INSERT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE TO DTI1147163;
...
-- ALTER TABLESPACE PSINDEX ADD DATAFILE SIZE 24G AUTOEXTEND ON NEXT 8192M MAXSIZE UNLIMITED;
-- ALTER TABLESPACE PSINDEX ADD DATAFILE SIZE 8G AUTOEXTEND ON NEXT 8192M MAXSIZE UNLIMITED;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/HC92MHOM';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/HC92MHOM';
...
INSERT INTO PS.PSDBOWNER  VALUES ('HC92MHOM','SYSADM');
COMMIT;
