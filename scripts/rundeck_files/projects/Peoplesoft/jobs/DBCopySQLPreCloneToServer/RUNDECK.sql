...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/RUNDECK';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/RUNDECK';
...
INSERT INTO PS.PSDBOWNER  VALUES ('RUNDECK','SYSADM');
