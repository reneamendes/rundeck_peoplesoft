...
CREATE USER DTI4500008 IDENTIFIED BY DTI4500008;
CREATE USER DTI4500013 IDENTIFIED BY DTI4500013;
CREATE USER DTI4500211 IDENTIFIED BY DTI4500211;

GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1073229;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1074573;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1140366;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1141992;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1147858;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1149524;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1707131;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI1906600;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI4500008;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI4500013;
GRANT CREATE SESSION, SELECT ANY TABLE, DELETE ANY TABLE, UPDATE ANY TABLE, INSERT ANY TABLE TO DTI4500211;
...
CREATE TABLESPACE HRLARGE DATAFILE SIZE 128M AUTOEXTEND ON NEXT 128M MAXSIZE 32767M;
...
CREATE TABLESPACE PSDEFAULT DATAFILE SIZE 24G AUTOEXTEND ON NEXT 4096M MAXSIZE 32767M;
...
CREATE DIRECTORY ORABACKUP AS '/orabackup/bkpixf/FS91MDES';
CREATE DIRECTORY EXPDP_DIR AS '/orabackup/bkpixf/FS91MDES';
...
INSERT INTO PS.PSDBOWNER  VALUES ('FS91MDES','SYSADM');
COMMIT;
